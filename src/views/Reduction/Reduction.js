...
const Reduction = () => {
  ...
  const fetchCompanies = async () => {
    await axios.post(`${api_endpoint}/api/getReductionRank`, postData).then(({data})=>{
                  ...
                  <Table aria-label="simple table">
                    <TableHead>
                      <TableRow>
                        ...
                        <TableCell align='center' sx={{ color: '#262626', borderColor: '#BEC0C4', fontSize: { xs: '10px', md: '14px' }, fontWeight: { xs: '400', md: '500' } }}>削減量</TableCell>
                          ...
                          companies.map((item, i) => (
                            ...
                            >
                              ...
                              <TableCell sx={{ color: '#262626', borderColor: '#BEC0C4', fontSize: { xs: '10px', md: '14px' }, fontWeight: { xs: '400', md: '500' } }}>
                                {item.emossion_year}年度 削減量 {parseInt(item.reduction_emission).toLocaleString()} tCO2 {item.reduction_emission >= 0 ? <ArrowUpward sx={{ verticalAlign: 'middle', fontSize: { xs: '10px', md: '14px' }, fontWeight: { xs: '400', md: '500' } }} /> : <ArrowDownward sx={{ verticalAlign: 'middle', fontSize: { xs: '10px', md: '14px' }, fontWeight: { xs: '400', md: '500' } }} />}
                              </TableCell>
